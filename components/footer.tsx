      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center flex flex-col items-center">
            ...
            <h3 className="text-lg font-semibold mb-4 text-primary">Don&apos;s Stripping Inc.</h3>
          ...
          <div className="text-center">
            ...
            <ul className="space-y-2">
              {navItems.map((item) => (
                <li key={item.href}>
                  <Link href={item.href} className="text-sm hover:text-primary transition-colors duration-200">
                    {item.label}
                  </Link>
                </li>
              ))}
          ...
          <div className="text-center">
            ...
            <div className="space-y-2 flex flex-col items-center">
              <Button variant="outline" asChild size="sm" className="w-auto hover:bg-primary hover:text-primary-foreground">
            ...
            <h4 className="text-md font-semibold mt-4 mb-2 text-primary">Follow Us</h4>
